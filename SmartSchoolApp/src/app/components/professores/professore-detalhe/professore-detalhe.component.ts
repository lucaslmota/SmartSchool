...
@Component({
  selector: 'app-professore-detalhe',
  templateUrl: './professore-detalhe.component.html',
  styleUrls: ['./professore-detalhe.component.css']
})
export class ProfessoreDetalheComponent implements OnInit, OnDestroy {
